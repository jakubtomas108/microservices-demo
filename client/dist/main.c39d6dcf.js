...
var totalSick = document.getElementById("totalSick");
var todaySick = document.getElementById("todaySick");
var freeSpaces = document.getElementById("freeSpaces");
var ambulanceFor = document.getElementById("ambulanceFor");
var sickButton = document.getElementById("submitSickness");
var errText = "Service is unavailable at the moment";

var checkResult = function checkResult(data) {
  sickButton.style.display = "none";

  if (!data) {
    alert("Hospital is currently unavailable, but once its ready, it will dispatch for You");
  } else {
    console.log(data);
  }
};
...
sickButton.addEventListener("click", function () {
  axios_1.default.post("http://localhost:5002/report-sickness").then(function (_a) {
    var data = _a.data;
...
var getData = function getData() {
  axios_1.default.get("http://localhost:5002/status").then(function (data) {
